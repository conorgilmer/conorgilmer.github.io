	...
	*/	
	protected function drawValueLabels($graphPoints, $dataStructure) {
		...
		if($this->cfg['value-label-visible']) {
			...
			$valueLabelColor = $this->allocateColor($this->cfg['value-label-color']);
			//Draw strings
			imagestringup($this->ip, $this->cfg['value-label-font-size'], $graphPoints['value']['min']['x1'], $graphPoints['value']['min']['y1'], $dataStructure['fakeMin'], $valueLabelColor);
			imagestringup($this->ip, $this->cfg['value-label-font-size'], $graphPoints['value']['max']['x1'], $graphPoints['value']['max']['y1'], $dataStructure['fakeMax'], $valueLabelColor);
		}			
